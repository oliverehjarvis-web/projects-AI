package com.oli.projectsai.features.repo
...
private fun RepoListContent(
    repos: List<com.oli.projectsai.features.repo.github.GitHubClient.Repo>,
    onPick: (com.oli.projectsai.features.repo.github.GitHubClient.Repo) -> Unit
) {
    if (repos.isEmpty()) {
